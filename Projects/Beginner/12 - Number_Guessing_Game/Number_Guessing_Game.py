...
def compare_guess():
    """Handles user guess and returns "Too High" or "Too Low" or if the user found the number guessed based on users guess"""
...
while user_lives != 0:
    ...
    return_compare_guess = compare_guess()
    print(return_compare_guess)
